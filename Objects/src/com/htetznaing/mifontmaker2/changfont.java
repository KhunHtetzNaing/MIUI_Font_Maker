...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 21;BA.debugLine="Activity.Title = \"Change Font\"";
mostCurrent._activity.setTitle((Object)("Change Font"));
 //BA.debugLineNum = 22;BA.debugLine="Banner.Initialize(\"Banner\",\"ca-app-pub-4173348573";
mostCurrent._banner.Initialize(mostCurrent.activityBA,"Banner","ca-app-pub-4173348573252986/4626693352");
 //BA.debugLineNum = 23;BA.debugLine="Banner.LoadAd";
mostCurrent._banner.LoadAd();
 //BA.debugLineNum = 24;BA.debugLine="Activity.AddView(Banner,0%x,100%y - 50dip,100%x,5";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._banner.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0),mostCurrent.activityBA),(int) (anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50))),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)));
 //BA.debugLineNum = 26;BA.debugLine="Interstitial.Initialize(\"Interstitial\",\"ca-app-pu";
mostCurrent._interstitial.Initialize(mostCurrent.activityBA,"Interstitial","ca-app-pub-4173348573252986/7580159759");
 //BA.debugLineNum = 27;BA.debugLine="Interstitial.LoadAd";
mostCurrent._interstitial.LoadAd();
 //BA.debugLineNum = 29;BA.debugLine="ad.Initialize(\"ad\",60000)";
_ad.Initialize(processBA,"ad",(long) (60000));
 //BA.debugLineNum = 30;BA.debugLine="ad.Enabled = True";
...
mostCurrent._lb.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 33;BA.debugLine="lb.Text = \"MIUI 8++\"";
mostCurrent._lb.setText((Object)("MIUI 8++"));
 //BA.debugLineNum = 34;BA.debugLine="lb.TextSize = 25";
mostCurrent._lb.setTextSize((float) (25));
 //BA.debugLineNum = 35;BA.debugLine="Activity.AddView(lb,0%x,10%y,100%x,5%y)";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._lb.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (10),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (5),mostCurrent.activityBA));
 //BA.debugLineNum = 36;BA.debugLine="lb.Gravity = Gravity.CENTER";
mostCurrent._lb.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 38;BA.debugLine="Activity.AddMenuItem3(\"Share App\",\"share\",LoadBitm";
mostCurrent._activity.AddMenuItem3((java.lang.CharSequence)("Share App"),"share",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"share.png").getObject()),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 39;BA.debugLine="b1.Initialize(\"b1\")";
mostCurrent._b1.Initialize(mostCurrent.activityBA,"b1");
 //BA.debugLineNum = 40;BA.debugLine="b1.Text = \"Import Font\"";
mostCurrent._b1.setText((Object)("Import Font"));
 //BA.debugLineNum = 42;BA.debugLine="b2.Initialize(\"b2\")";
mostCurrent._b2.Initialize(mostCurrent.activityBA,"b2");
 //BA.debugLineNum = 43;BA.debugLine="b2.Text = \"Change Font\"";
mostCurrent._b2.setText((Object)("Change Font"));
 //BA.debugLineNum = 45;BA.debugLine="Activity.AddView(b1,20%x,20%y,60%x,10%y)";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._b1.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (20),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (60),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (10),mostCurrent.activityBA));
 //BA.debugLineNum = 46;BA.debugLine="Activity.AddView(b2,20%x,(b1.Top+b1.Height)+1%y,60";
...
public static String  _ad_tick() throws Exception{
 //BA.debugLineNum = 92;BA.debugLine="Sub ad_Tick";
 //BA.debugLineNum = 93;BA.debugLine="If Interstitial.Ready Then Interstitial.Show";
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 //BA.debugLineNum = 49;BA.debugLine="Sub b1_Click";
 //BA.debugLineNum = 50;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 51;BA.debugLine="i.Initialize(i.ACTION_VIEW,\"com.android.thememana";
_i.Initialize(_i.ACTION_VIEW,"com.android.thememanager");
 //BA.debugLineNum = 52;BA.debugLine="StartActivity(i)";
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 //BA.debugLineNum = 55;BA.debugLine="Sub b2_Click";
 //BA.debugLineNum = 56;BA.debugLine="Try";
try { //BA.debugLineNum = 57;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 58;BA.debugLine="i.Initialize(\"\", \"\")";
_i.Initialize("","");
 //BA.debugLineNum = 59;BA.debugLine="i.SetComponent(\"com.android.settings/.Settings$F";
_i.SetComponent("com.android.settings/.Settings$FontSettingsActivity");
 //BA.debugLineNum = 60;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.getObject()));
 } 
       catch (Exception e7) {
			processBA.setLastException(e7); //BA.debugLineNum = 62;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 63;BA.debugLine="i.Initialize(i.ACTION_VIEW,\"com.android.thememan";
_i.Initialize(_i.ACTION_VIEW,"com.android.thememanager");
...
mostCurrent._b2 = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 14;BA.debugLine="Dim copy As BClipboard";
mostCurrent._copy = new b4a.util.BClipboard();
 //BA.debugLineNum = 15;BA.debugLine="Dim Banner As AdView";
mostCurrent._banner = new anywheresoftware.b4a.admobwrapper.AdViewWrapper();
 //BA.debugLineNum = 16;BA.debugLine="Dim Interstitial As InterstitialAd";
mostCurrent._interstitial = new anywheresoftware.b4a.admobwrapper.AdViewWrapper.InterstitialAdWrapper();
 //BA.debugLineNum = 17;BA.debugLine="Dim lb As Label";
...
public static String  _interstitial_adclosed() throws Exception{
 //BA.debugLineNum = 88;BA.debugLine="Sub Interstitial_AdClosed";
 //BA.debugLineNum = 89;BA.debugLine="Interstitial.LoadAd";
mostCurrent._interstitial.LoadAd();
...
anywheresoftware.b4a.objects.IntentWrapper _shareit = null;
 //BA.debugLineNum = 76;BA.debugLine="Sub share_Click";
 //BA.debugLineNum = 77;BA.debugLine="Dim ShareIt As Intent";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 79;BA.debugLine="copy.setText(\"You can change easily any font you";
...
_shareit.SetType("text/plain");
 //BA.debugLineNum = 82;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.TEXT\",cop";
_shareit.PutExtra("android.intent.extra.TEXT",(Object)(mostCurrent._copy.getText(mostCurrent.activityBA)));
 //BA.debugLineNum = 83;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.SUBJECT\",";
